...
const BLOG = {
  AUTHOR: 'z', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://nt.zwant.win', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || 'b42f89857c7347b8991b52b0974a29f8', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
